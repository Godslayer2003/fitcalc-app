        ...
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          <div className="col-span-2 sm:col-span-1">
            <Link href="/" className="flex items-center gap-2 text-base font-bold tracking-tight">
              <span className="flex h-6 w-6 items-center justify-center rounded-[22%] bg-accent text-white">
                <Activity className="h-3.5 w-3.5" strokeWidth={2.5} />
              </span>
              {siteConfig.name}
            </Link>
            <p className="mt-3 max-w-[22ch] text-sm text-zinc-500 dark:text-zinc-400">
              Standard, published formulas. Create an account to track your progress.
            </p>
          </div>
